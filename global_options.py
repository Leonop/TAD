...
RAM_CORENLP: str = "120"  # max RAM allocated for parsing using CoreNLP; increase to speed up parsing
...
os.environ['CORENLP_HOME'] = "/home/zichengx/Research/TAD/w2v_culture/stanford-corenlp-full-2018-10-05/"
...
DATA_FOLDER_W2V = os.path.join(PROJECT_DIR, "w2v_culture", "data")
...
START_ROWS = 0000000 # start row to read from the csv file
